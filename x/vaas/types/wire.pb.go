...
type ConsumerPacketData struct {
	Type ConsumerPacketDataType `protobuf:"varint,1,opt,name=type,proto3,enum=vaas.v1.ConsumerPacketDataType" json:"type,omitempty"`
...
type SlashPacketDataV1 struct {
	...
	ValsetUpdateId uint64 `protobuf:"varint,2,opt,name=valset_update_id,json=valsetUpdateId,proto3" json:"valset_update_id,omitempty"`
	// tell if the slashing is for a downtime or a double-signing infraction
	Infraction InfractionType `protobuf:"varint,3,opt,name=infraction,proto3,enum=vaas.v1.InfractionType" json:"infraction,omitempty"`
}
...
func init() {
	proto.RegisterEnum("vaas.v1.ConsumerPacketDataType", ConsumerPacketDataType_name, ConsumerPacketDataType_value)
	proto.RegisterEnum("vaas.v1.InfractionType", InfractionType_name, InfractionType_value)
	proto.RegisterType((*ValidatorSetChangePacketData)(nil), "vaas.v1.ValidatorSetChangePacketData")
	proto.RegisterType((*VSCMaturedPacketData)(nil), "vaas.v1.VSCMaturedPacketData")
	proto.RegisterType((*SlashPacketData)(nil), "vaas.v1.SlashPacketData")
	proto.RegisterType((*ConsumerPacketData)(nil), "vaas.v1.ConsumerPacketData")
	proto.RegisterType((*HandshakeMetadata)(nil), "vaas.v1.HandshakeMetadata")
	proto.RegisterType((*ConsumerPacketDataV1)(nil), "vaas.v1.ConsumerPacketDataV1")
	proto.RegisterType((*SlashPacketDataV1)(nil), "vaas.v1.SlashPacketDataV1")
}

func init() { proto.RegisterFile("vaas/v1/wire.proto", fileDescriptor_ff0c076158c7a6e4) }
