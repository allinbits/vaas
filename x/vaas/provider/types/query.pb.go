...
type Chain struct {
	...
	FeePoolAddress string `protobuf:"bytes,7,opt,name=fee_pool_address,json=feePoolAddress,proto3" json:"fee_pool_address,omitempty"`
}
...
type QueryConsumerChainResponse struct {
	...
	// The deterministic provider-side account that must be funded
	// to cover per-block fees for this consumer chain.
	FeePoolAddress string `protobuf:"bytes,9,opt,name=fee_pool_address,json=feePoolAddress,proto3" json:"fee_pool_address,omitempty"`
}
...
func (m *QueryConsumerFeePoolClaimRequest) GetConsumerId() string {
	if m != nil {
		return m.ConsumerId
	}
	return ""
...
func (m *QueryConsumerFeePoolClaimsRequest) GetConsumerId() string {
	if m != nil {
		return m.ConsumerId
	}
	return ""
...
var fileDescriptor_71b3f55ed407aa51 = []byte{
	...
	,
}
