...
func TestValidateParams(t *testing.T) {
	testCases := []struct {
		...
		{"custom valid params", types.NewParams("0.33", time.Hour, 1000, 180, math.NewInt(42), types.DefaultMinDepositBlocks), true},
		{"zero fees per block", types.NewParams("0.33", time.Hour, 1000, 180, math.NewInt(0), types.DefaultMinDepositBlocks), false},
