...
type PendingDowntimeSlash struct {
	...
	// consumer_cons_addr is the reporting validator's consensus address on the
	// consumer chain, captured at acceptance. A challenge names this address,
	// and provider_cons_addr above is derived from it through the key-assignment
	// mapping; storing it lets the challenge find this slash even after that
	// mapping is pruned or the validator rotates its consumer key.
	ConsumerConsAddr []byte `protobuf:"bytes,9,opt,name=consumer_cons_addr,json=consumerConsAddr,proto3" json:"consumer_cons_addr,omitempty"`
}
...
func (m *PendingDowntimeSlash) GetConsumerConsAddr() []byte {
	if m != nil {
		return m.ConsumerConsAddr
	}
	return nil
}
...
var fileDescriptor_6404dd5d21545279 = []byte{
	...
	,
}
...
func (m *PendingDowntimeSlash) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ConsumerConsAddr) > 0 {
		i -= len(m.ConsumerConsAddr)
		copy(dAtA[i:], m.ConsumerConsAddr)
		i = encodeVarintProvider(dAtA, i, uint64(len(m.ConsumerConsAddr)))
		i--
		dAtA[i] = 0x4a
	}
...
func (m *AcceptedDowntimeWindow) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n21, err21 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.AcceptedAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.AcceptedAt):])
	if err21 != nil {
		return 0, err21
	}
	i -= n21
...
func (m *PreviousDowntimeParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n22, err22 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.ChangedAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.ChangedAt):])
	if err22 != nil {
		return 0, err22
	}
	i -= n22
...
func (m *SlashJailParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n26, err26 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.JailDuration, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.JailDuration):])
	if err26 != nil {
		return 0, err26
	}
	i -= n26
...
func (m *PendingDowntimeSlash) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConsumerConsAddr", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConsumerConsAddr = append(m.ConsumerConsAddr[:0], dAtA[iNdEx:postIndex]...)
			if m.ConsumerConsAddr == nil {
				m.ConsumerConsAddr = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
