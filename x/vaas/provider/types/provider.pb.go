...
type ConsensusValidator struct {
	...
	// provider block height at which the validator entered this consumer's
	// validator set. It is stamped the first time the validator appears in the
	// set and then carried forward unchanged for every epoch it stays in, so it
	// only moves if the validator drops out of the set and later rejoins. It is
	// always zero on the provider's own consensus validators, which are not
	// scoped to a consumer.
	//
	// Nothing on the provider compares an infraction height against this field:
	// downtime evidence is bounded on the consumer, which trims each
	// validator's missed-block window to the first height it saw that validator
	// vote. The field is retained because it is the provider's own record of
	// when a validator joined a given consumer, and it is the durable one: it
	// persists for as long as the validator stays in the set, whereas the
	// consumer's first-seen heights are local to that consumer and cleared
	// every time a downtime window closes. It is state only, and is not carried
	// in module genesis, in any query response, or in any packet the provider
	// sends.
...
var fileDescriptor_6404dd5d21545279 = []byte{
	...
	,
}
...
func (m *ConsumerAddrsToPrune) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n5, err5 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.PruneTs, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.PruneTs):])
	if err5 != nil {
		return 0, err5
	}
	i -= n5
...
func (m *ConsumerInitializationParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n7, err7 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.SafeModeThreshold, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.SafeModeThreshold):])
	if err7 != nil {
		return 0, err7
	}
	i -= n7
...
func (m *InfractionParameters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n14, err14 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.DowntimeEvidenceMaxAge, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.DowntimeEvidenceMaxAge):])
	if err14 != nil {
		return 0, err14
	}
	i -= n14
	...
	i--
	dAtA[i] = 0x3a
	n15, err15 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.DowntimeChallengeWindow, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.DowntimeChallengeWindow):])
	if err15 != nil {
		return 0, err15
	}
	i -= n15
	...
	n16, err16 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.DowntimeGracePeriod, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.DowntimeGracePeriod):])
	if err16 != nil {
		return 0, err16
	}
	i -= n16
...
func (m *PendingDowntimeSlash) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n19, err19 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.MaturesAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.MaturesAt):])
	if err19 != nil {
		return 0, err19
	}
	i -= n19
...
func (m *AcceptedDowntimeWindow) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n20, err20 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.AcceptedAt, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.AcceptedAt):])
	if err20 != nil {
		return 0, err20
	}
	i -= n20
