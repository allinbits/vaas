...
type Params struct {
	...
	FeesPerBlockAmount cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=fees_per_block_amount,json=feesPerBlockAmount,proto3,customtype=cosmossdk.io/math.Int" json:"fees_per_block_amount"`
	...
	MinDepositBlocks uint64 `protobuf:"varint,5,opt,name=min_deposit_blocks,json=minDepositBlocks,proto3" json:"min_deposit_blocks,omitempty"`
}
...
var fileDescriptor_6404dd5d21545279 = []byte{
	...
	,
}
