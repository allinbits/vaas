...
var (
	...
	ConsumerIdToLastLivenessTimePrefix     = collections.NewPrefix(28)
	AckedConsumerValidatorsPrefix          = collections.NewPrefix(29)
	LatestSentConsumerValidatorsPrefix     = collections.NewPrefix(30)
	ConsumerIdToLatestSentVscIdPrefix      = collections.NewPrefix(31)
