...
var (
	...
	ConsumerFeePoolSharesPrefix            = collections.NewPrefix(24)
	ConsumerFeePoolTotalSharesPrefix       = collections.NewPrefix(25)
	FeePoolAddressToConsumerIdPrefix       = collections.NewPrefix(26)
