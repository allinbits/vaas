...
type GenesisState struct {
	...
	// empty for a new chain
	ValidatorConsumerPubkeys []ValidatorConsumerPubKey `protobuf:"bytes,4,rep,name=validator_consumer_pubkeys,json=validatorConsumerPubkeys,proto3" json:"validator_consumer_pubkeys"`
	// empty for a new chain
	ValidatorsByConsumerAddr []ValidatorByConsumerAddr `protobuf:"bytes,5,rep,name=validators_by_consumer_addr,json=validatorsByConsumerAddr,proto3" json:"validators_by_consumer_addr"`
	// empty for a new chain
	ConsumerAddrsToPrune []ConsumerAddrsToPrune `protobuf:"bytes,6,rep,name=consumer_addrs_to_prune,json=consumerAddrsToPrune,proto3" json:"consumer_addrs_to_prune"`
	...
	ConsumerFeesPerBlockOverrides []ConsumerFeesPerBlockOverride `protobuf:"bytes,7,rep,name=consumer_fees_per_block_overrides,json=consumerFeesPerBlockOverrides,proto3" json:"consumer_fees_per_block_overrides"`
	// empty for a new chain
	...
	// a new chain.
	PendingDowntimeSlashes []PendingDowntimeSlash `protobuf:"bytes,9,rep,name=pending_downtime_slashes,json=pendingDowntimeSlashes,proto3" json:"pending_downtime_slashes"`
	...
	// changed.
	PreviousDowntimeParams *PreviousDowntimeParams `protobuf:"bytes,10,opt,name=previous_downtime_params,json=previousDowntimeParams,proto3" json:"previous_downtime_params,omitempty"`
	// Per-validator fee-share records from each consumer's fee distribution
	// runs. Empty for a new chain.
	EpochShareRecords []EpochShareRecord `protobuf:"bytes,11,rep,name=epoch_share_records,json=epochShareRecords,proto3" json:"epoch_share_records"`
	...
	InfractionParameters *InfractionParameters `protobuf:"bytes,12,opt,name=infraction_parameters,json=infractionParameters,proto3" json:"infraction_parameters,omitempty"`
	// Fee shares withheld from validators pending a downtime challenge window,
	// or already forfeited. Empty for a new chain.
	WithheldFeeRecords []WithheldFeeRecord `protobuf:"bytes,13,rep,name=withheld_fee_records,json=withheldFeeRecords,proto3" json:"withheld_fee_records"`
	...
	AcceptedDowntimeWindows []AcceptedDowntimeWindowRecord `protobuf:"bytes,14,rep,name=accepted_downtime_windows,json=acceptedDowntimeWindows,proto3" json:"accepted_downtime_windows"`
	// Per-(consumer, validator) downtime marks for the epoch fee distribution
	// currently in progress. Empty for a new chain.
	EpochDowntimeEntries []EpochDowntimeEntry `protobuf:"bytes,15,rep,name=epoch_downtime_entries,json=epochDowntimeEntries,proto3" json:"epoch_downtime_entries"`
	...
	// new chain.
	DowntimeWindowFloors []DowntimeWindowFloor `protobuf:"bytes,16,rep,name=downtime_window_floors,json=downtimeWindowFloors,proto3" json:"downtime_window_floors"`
}
...
type ConsumerState struct {
	...
	InDebt bool `protobuf:"varint,17,opt,name=in_debt,json=inDebt,proto3" json:"in_debt,omitempty"`
}
...
func (m *ConsumerState) GetInDebt() bool {
	if m != nil {
		return m.InDebt
	}
	return false
...
var fileDescriptor_c9071b84cde652f9 = []byte{
	...
	,
}
...
func (m *ConsumerState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InDebt", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
