...
// MsgUpdateInfractionParams is the Msg/UpdateInfractionParams request type. It
// replaces the provider's infraction parameters in full: the slash/jail policy
// for consumer double-signs and downtime, the downtime SLA window, the
// challenge window and the evidence max age.
//
// The infraction parameters are stored as their own state item rather than
// inside Params, so they get their own governance message: a fee or epoch
// change need not restate the whole slashing policy, and vice versa. Both
...
// new values from the next VSC packet and activate them at their next window
// boundary, while evidence already in flight echoes the old values; the
// provider keeps accepting those for downtime_evidence_max_age +
// downtime_challenge_window after the change (see AcceptableDowntimeParams).
type MsgUpdateInfractionParams struct {
	// authority is the address of the governance account.
	Authority string `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	// infraction_parameters replaces the stored set in full.
...
func (m *MsgUpdateInfractionParams) Reset()         { *m = MsgUpdateInfractionParams{} }
func (m *MsgUpdateInfractionParams) String() string { return proto.CompactTextString(m) }
func (*MsgUpdateInfractionParams) ProtoMessage()    {}
func (*MsgUpdateInfractionParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07778b1d094765c, []int{8}
}
func (m *MsgUpdateInfractionParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgUpdateInfractionParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgUpdateInfractionParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgUpdateInfractionParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgUpdateInfractionParams.Merge(m, src)
}
func (m *MsgUpdateInfractionParams) XXX_Size() int {
	return m.Size()
}
func (m *MsgUpdateInfractionParams) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgUpdateInfractionParams.DiscardUnknown(m)
}

var xxx_messageInfo_MsgUpdateInfractionParams proto.InternalMessageInfo

func (m *MsgUpdateInfractionParams) GetAuthority() string {
	if m != nil {
		return m.Authority
	}
	return ""
...
func (m *MsgUpdateInfractionParams) GetInfractionParameters() InfractionParameters {
	if m != nil {
...
type MsgUpdateInfractionParamsResponse struct {
}

func (m *MsgUpdateInfractionParamsResponse) Reset()         { *m = MsgUpdateInfractionParamsResponse{} }
func (m *MsgUpdateInfractionParamsResponse) String() string { return proto.CompactTextString(m) }
func (*MsgUpdateInfractionParamsResponse) ProtoMessage()    {}
func (*MsgUpdateInfractionParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07778b1d094765c, []int{9}
}
func (m *MsgUpdateInfractionParamsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgUpdateInfractionParamsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgUpdateInfractionParamsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgUpdateInfractionParamsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgUpdateInfractionParamsResponse.Merge(m, src)
}
func (m *MsgUpdateInfractionParamsResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgUpdateInfractionParamsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgUpdateInfractionParamsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgUpdateInfractionParamsResponse proto.InternalMessageInfo
...
type MsgUpdateConsumer struct {
	...
	// (optional) The IBC client the provider uses to reach the consumer,
	// declared by the owner once the consumer is LAUNCHED and a relayer has
	// created the client. Settable exactly once: the field is accepted only
	// while no client is set for the consumer, and the declared client must be
	// an Active tendermint client of the consumer's chain id with a registered
	// IBC v2 counterparty and a trusting period that outlives the downtime
	// challenge horizon. Replacing a dead client afterwards is governance's
	// MsgRecoverClient, which substitutes state under the same client id.
...
func (m *MsgUpdateConsumer) GetClientId() string {
	if m != nil {
		return m.ClientId
	}
	return ""
...
func (*MsgResumeConsumer) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07778b1d094765c, []int{26}
}
...
func (*MsgResumeConsumerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07778b1d094765c, []int{27}
}
...
func init() {
	...
	proto.RegisterType((*MsgUpdateInfractionParams)(nil), "vaas.provider.v1.MsgUpdateInfractionParams")
	proto.RegisterType((*MsgUpdateInfractionParamsResponse)(nil), "vaas.provider.v1.MsgUpdateInfractionParamsResponse")
...
var fileDescriptor_a07778b1d094765c = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	UpdateInfractionParams(ctx context.Context, in *MsgUpdateInfractionParams, opts ...grpc.CallOption) (*MsgUpdateInfractionParamsResponse, error)
...
func (c *msgClient) UpdateInfractionParams(ctx context.Context, in *MsgUpdateInfractionParams, opts ...grpc.CallOption) (*MsgUpdateInfractionParamsResponse, error) {
	out := new(MsgUpdateInfractionParamsResponse)
	err := c.cc.Invoke(ctx, "/vaas.provider.v1.Msg/UpdateInfractionParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	UpdateInfractionParams(context.Context, *MsgUpdateInfractionParams) (*MsgUpdateInfractionParamsResponse, error)
...
func (*UnimplementedMsgServer) UpdateInfractionParams(ctx context.Context, req *MsgUpdateInfractionParams) (*MsgUpdateInfractionParamsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateInfractionParams not implemented")
}
...
func _Msg_UpdateInfractionParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgUpdateInfractionParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).UpdateInfractionParams(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vaas.provider.v1.Msg/UpdateInfractionParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).UpdateInfractionParams(ctx, req.(*MsgUpdateInfractionParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateInfractionParams",
			Handler:    _Msg_UpdateInfractionParams_Handler,
		},
		{
...
func (m *MsgUpdateInfractionParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgUpdateInfractionParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgUpdateInfractionParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgUpdateInfractionParamsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgUpdateInfractionParamsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgUpdateInfractionParamsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgUpdateInfractionParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgUpdateInfractionParamsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgUpdateInfractionParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgUpdateInfractionParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgUpdateInfractionParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgUpdateInfractionParamsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgUpdateInfractionParamsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgUpdateInfractionParamsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
