...
func init() {
	...
	proto.RegisterType((*OutstandingDowntime)(nil), "vaas.consumer.v1.OutstandingDowntime")
	proto.RegisterType((*LastTransmissionBlockHeight)(nil), "vaas.consumer.v1.LastTransmissionBlockHeight")
	proto.RegisterType((*ConsumerPacketDataList)(nil), "vaas.consumer.v1.ConsumerPacketDataList")
}

func init() {
	proto.RegisterFile("vaas/consumer/v1/genesis.proto", fileDescriptor_c0a5dda3054285ac)
}
